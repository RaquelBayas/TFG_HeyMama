...
class ListaUsuariosAdapter(private val context: Context, private var listaUsuarios: ArrayList<User>,private val usersListener: ItemRecyclerViewListener
    ...
    /**
     * Este método filtra la lista de usuarios
     */
    ...
    /**
     * Menú del usuario: cuenta con la opción 'Eliminar' para "eliminar" la cuenta del usuario.
     * En el caso del administrador, al intentar eliminar la cuenta de un usuario, se borrarán todas
     * las referencias creadas en las bases de datos usadas, pero no se eliminará de FirebaseAuth,
     * ya que sería necesario Firebase Admin SDK lo cual podría implementarse en el futuro, y la
     * cuenta quedaría más bien "bloqueada" ya que el usuario igualmente no podrá iniciar sesión.
     */
