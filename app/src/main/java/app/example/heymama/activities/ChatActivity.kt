...
import app.example.heymama.adapters.ChatAdapter
import app.example.heymama.databinding.ActivityChatBinding
        ...
        val dialog = AlertDialog.Builder(this, R.style.AlertDialogTheme)
            ...
            .setPositiveButton("Eliminar") { view, _ ->
                if (!Utils.isNetworkAvailable(applicationContext)) {
                    Utils.alertDialogInternet(applicationContext)
                            ...
                            override fun onResponse(call: Call<MyResponse?>, response: Response<MyResponse?>) {
                                if(response.code()==200) {
                                    if(response.body()!!.success!==1) {
                                        Log.i("CHAT.NOT",response.body()!!.success.toString())
