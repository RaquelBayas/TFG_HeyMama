...
import app.example.heymama.adapters.RespuestaConsultaAdapter
import app.example.heymama.databinding.ActivityRespuestaConsultaBinding
...
class RespuestaConsultaActivity : AppCompatActivity() {
    ...
    /**
     * Inicializa el recyclerView, y arraylists utilizados
     */
